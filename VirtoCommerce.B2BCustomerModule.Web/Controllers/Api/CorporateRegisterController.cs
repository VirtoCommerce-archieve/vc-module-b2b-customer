...
namespace VirtoCommerce.B2BCustomerModule.Web.Controllers.Api
{
    [RoutePrefix("api/b2b")]
    public class CorporateRegisterController : CorporateControllerBase
    {
        ...
        public async Task<IHttpActionResult> RegisterCompanyOwner(CompanyOwnerRegistrationData registrationData)
        {
